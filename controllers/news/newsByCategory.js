...
const newsByCategory = async (req, res, next) => {
  ...
  try {
    ...
    if (!listOfCategories.find((e) => e === category)) {
      throw generateError('La categoría no existe, por favor filtre por una de las siguientes categorías: deportes, videojuegos, noticias, programación, viajes, tecnología, música, memes, general');
    };
